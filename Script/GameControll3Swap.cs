...
public class GameControll3Swap : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Dog.IsFinish == true)
        {
            ...
            PlayerPrefs.SetInt("Dialogue3Swap", Rate);
            if (PlayerPrefs.GetInt("HighScore-Main3Swap") < score)
            {
                PlayerPrefs.SetInt("HighScore-Main3Swap", score);
            }
