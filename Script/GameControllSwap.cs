...
public class GameControllSwap : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Dog.IsFinish == true)
        {
            ...
            PlayerPrefs.SetInt("Dialogue1Swap", Rate);
            if (PlayerPrefs.GetInt("HighScore-Main1Swap") < score)
            {
                PlayerPrefs.SetInt("HighScore-Main1Swap", score);
            }
