...
public class GameControll2Swap : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Dog.IsFinish == true)
        {
            ...
            PlayerPrefs.SetInt("Dialogue2Swap", Rate);
            if (PlayerPrefs.GetInt("HighScore-Main2Swap") < score)
            {
                PlayerPrefs.SetInt("HighScore-Main2Swap", score);
            }
