...
public class TitleControllerSwap : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        MyAnswer1_1[PlayerPrefs.GetInt("1-1SwapMyAnswer")].SetActive(true);
        MyAnswer1_2[PlayerPrefs.GetInt("1-2SwapMyAnswer")].SetActive(true);
        MyAnswer1_3[PlayerPrefs.GetInt("1-3SwapMyAnswer")].SetActive(true);
        MyAnswer2_1[PlayerPrefs.GetInt("2-1SwapMyAnswer")].SetActive(true);
        MyAnswer2_2[PlayerPrefs.GetInt("2-2SwapMyAnswer")].SetActive(true);
        MyAnswer2_3[PlayerPrefs.GetInt("2-3SwapMyAnswer")].SetActive(true);
        MyAnswer3_1[PlayerPrefs.GetInt("3-1SwapMyAnswer")].SetActive(true);
        MyAnswer3_2[PlayerPrefs.GetInt("3-2SwapMyAnswer")].SetActive(true);
        MyAnswer3_3[PlayerPrefs.GetInt("3-3SwapMyAnswer")].SetActive(true);
        HighScore_Main.text = PlayerPrefs.GetInt("HighScore-Main1Swap") + "";
        HighScore_Main2.text = PlayerPrefs.GetInt("HighScore-Main2Swap") + "";
        HighScore_Main3.text = PlayerPrefs.GetInt("HighScore-Main3Swap") + "";
    ...
    public void GameStartButton()
    {
        ...
        SceneManager.LoadScene("LoadingSwap");
