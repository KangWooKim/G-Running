...
public class GameControll2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Dog.IsFinish == true)
        {
            ...
            PlayerPrefs.SetInt("Dialogue2", Rate);
            if (PlayerPrefs.GetInt("HighScore-Main2") < score)
            {
                PlayerPrefs.SetInt("HighScore-Main2", score);
            }
